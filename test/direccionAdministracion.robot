...
...
...               -Test 1: Se crea un tramite de la Direccion de administracion y lo aprueba la misma Direccion de administracion
...
...               -Test 2: Se crea un tramite de la Direccion de administracion y lo rechaza la misma Direccion de administracion
...
...               -Test 3: Se crea un tramite de la Direccion de administracion y desde la misma Direccion selecciona la opcion "No Corresponde"
...
...               -Test 4: Se crea un tramite de la Direccion de administracion y desde la misma Direccion selecciona la opcion "Solicitar Datos Adicionales"
...
...               -Test 5: Se crea un tramite de la Direccion de administracion y lo aprueba el Departamento de Contabilidad y Presupuesto
...
...               -Test 6: Se crea un tramite de la Direccion de administracion y lo rechaza el Departamento de Contabilidad y Presupuesto
...
...               -Test 7: Se crea un tramite de la Direccion de administracion y el Departamento de Contabilidad y Presupuesto solicita datos adicionales
...
...               -Test 8: Se crea un tramite de la Direccion de administracion y lo aprueba el Departamento de Patrimonio y Compras
...
...               -Test 9: Se crea un tramite de la Direccion de administracion y lo rechaza el Departamento de Patrimonio y Compras
...
...               -Test 10: Se crea un tramite de la Direccion de administracion y el Departamento de Patrimonio y Compras solicita datos adicionales
...
...               -Test 11: Se crea un tramite de la Direccion de administracion y lo aprueba el Departamento de Reursos Humanos
...
...               -Test 12: Se crea un tramite de la Direccion de administracion y lo rechaza el Departamento de Reursos Humanos
...
...               -Test 13: Se crea un tramite de la Direccion de administracion y el Departamento de Reursos Humanos solicita datos adicionales
...
...               -Test 14: Se crea un tramite de la Direccion de administracion y lo aprueba el Departamento de Tesorería
...
...               -Test 15: Se crea un tramite de la Direccion de administracion y lo rechaza el Departamento de Tesorería
...
...               -Test 16: Se crea un tramite de la Direccion de administracion y el Departamento de Tesorería solicita datos adicionales
...
***Test Cases***
#DIRECCION
#Test 1: Aprobado desde Direccion Administracion
#Test 2: Rechazado desde Direccion Administracion
#Test 3:no corresponde desde dire
#Test 4:solicita datos desde dire
...
#Test 14: Aprobado desde Tesoreria
#Test 15: Rechazado desde Tesoreria
#Test 16: Solicita datos adicionales en operador, direccion y departamento + rechaza

Test 1 - Aprobado desde Direccion Administracion [ciudadano] Paso 1
...
Test 1 - Aprobado desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 2
...
Test 1 - Aprobado desde Direccion Administracion verificar el estado del tramite (pendiente) [operador mesa] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
...
Test 1 - Aprobado desde Direccion Administracion [operador mesa] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 1 - Verificar el estado del tramite (asignado) [DireccionAdministracion] Paso 9
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administracion, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 1 - Aprobado desde Direccion Administracion verificar si los botones de acciones son correctos [DireccionAdministracion] Paso 11
...
Test 1 - Aprobado desde Direccion Administracion [DireccionAdministracion] Paso 12
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 1 - Aprobado desde Direccion Administracion verificar el estado del tramite (Finalizado) [DireccionAdministracion] Paso 13
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 1 - Aprobado desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 14
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 2 - Rechazado desde Direccion Administracion [ciudadano] Paso 1
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Crea un nuevo tramite
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - ciudadano  ${userCiudadano2}  ${passCiudadano}  ${circuloUsuario}
...
Test 2 - Rechazado desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 2 - Rechazado desde Direccion Administracion verificar el estado del tramite (pendiente) [operador mesa] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador mesa, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 2 - Rechazado desde Direccion Administracion [operador mesa] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
...
Test 2 - Verificar el estado del tramite (asignado) [DireccionAdministracion] Paso 9
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administracion, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 2 - Rechazado desde Direccion Administracion verificar si los botones de acciones son correctos [DireccionAdministracion] Paso 11
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 2 - Rechazado desde Direccion Administracion [DireccionAdministracion] Paso 12
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Direccion y utiliza la opcion "RechazarInformarAlContribuyente" para continuar con el proceso
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - operador  ${userDireccionAdministracion}  ${pass}  Reportes y Estadísticas
    Validar y hacer clic en el boton    ${botonBandejaEntrada}    botonBandejaEntrada
    Abrir Tramite Por Numero    ${tramite}
...
Test 2 - Rechazado desde Direccion Administracion verificar el estado del tramite (Finalizado) [DireccionAdministracion] Paso 13
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 2 - Rechazado desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 14
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion [ciudadano] Paso 1
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Crea un nuevo tramite
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - ciudadano  ${userCiudadano2}  ${passCiudadano}  ${circuloUsuario}
...
Test 3 - No Corresponde desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion verificar el estado del tramite (pendiente) [operador mesa] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador mesa, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion [operador mesa] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
...
Test 3 - Verificar el estado del tramite (asignado) [DireccionAdministracion] Paso 9
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administracion, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion verificar si los botones de acciones son correctos [DireccionAdministracion] Paso 11
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion [DireccionAdministracion] Paso 12
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Direccion y utiliza la opcion "Aprobar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 3 - Verificar si los botones de acciones son correctos [operador mesa] Paso 13
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Operador y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - operador  ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
    Validar y hacer clic en el boton    ${botonMesaEntradaVirtual}    botonMesaEntradaVirtual
    Abrir Tramite Por Numero    ${tramite}
...
Test 3 - No Corresponde desde Direccion Administracion [operador mesa] Paso 14
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion [DireccionAdministracion] Paso 15
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Direccion y utiliza la opcion "Aprobar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion verificar el estado del tramite (Finalizado) [DireccionAdministracion] Paso 16
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 3 - No Corresponde desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 17
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - SolicitarDatosAdicionales desde Direccion Administracion [ciudadano] Paso 1
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Crea un nuevo tramite
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - ciudadano  ${userCiudadano2}  ${passCiudadano}  ${circuloUsuario}
...
Test 4 - SolicitarDatosAdicionales desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - Verificar el estado del tramite (pendiente) [operador mesa] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador mesa, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - SolicitarDatosAdicionales desde Direccion Administracion [operador mesa] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
...
Test 4 - Verificar el estado del tramite (asignado) [DireccionAdministracion] Paso 9
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administracion, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - Verificar si los botones de acciones son correctos [DireccionAdministracion] Paso 11
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 4 - SolicitarDatosAdicionales desde Direccion Administracion [DireccionAdministracion] Paso 12
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Direccion y utiliza la opcion "Solicitar Datos Adicionales" para continuar con el proceso
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - operador  ${userDireccionAdministracion}  ${pass}  Reportes y Estadísticas
    Validar y hacer clic en el boton    ${botonBandejaEntrada}    botonBandejaEntrada
    Abrir Tramite Por Numero    ${tramite}
...
Test 4 - Solicitar Datos Adicionales El ciudadano avanza en el tramite [ciudadano] Paso 14
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló Solicitar Datos Adicionales desde Operador mesa
    Abrir Navegador en modo incognito    ${pageCiudadano}
...
Test 4 - SolicitarDatosAdicionales desde Direccion Administracion [DireccionAdministracion] Paso 15
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Direccion y utiliza la opcion "Aprobar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 4 - verificar el estado del tramite (Finalizado) [DireccionAdministracion] Paso 16
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador , se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - SolicitarDatosAdicionales desde Direccion Administracion Chequear Estado Desde Usuario [ciudadano] Paso 17
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 5 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo aprueba el DEPARTAMENTO DE CONTABILIDAD Y PRESUPUESTO
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 5 - Se selecciona la opcion "Aprobar e informar al contribuyente" [ContabilidadPresupuesto] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 6 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo rechaza el DEPARTAMENTO DE CONTABILIDAD Y PRESUPUESTO
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 6 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 6 - Verificar el estado del tramite (asignado) [ContabilidadPresupuesto] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento ContabilidadPresupuesto, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Verificar si los botones de acciones son correctos [ContabilidadPresupuesto] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento ContabilidadPresupuesto y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 6 - Se selecciona la opcion "Rechazar e informar al contribuyente" [ContabilidadPresupuesto] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 6 - Verificar que el tramite no exista [ContabilidadPresupuesto] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento ContabilidadPresupuesto, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 6 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [ContabilidadPresupuesto] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento ContabilidadPresupuesto, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 6 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Administración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 7 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y el DEPARTAMENTO DE CONTABILIDAD Y PRESUPUESTO solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 7 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 7 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 7 - Verificar el estado del tramite (asignado) [ContabilidadPresupuesto] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento ContabilidadPresupuesto, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 7 - Verificar si los botones de acciones son correctos [ContabilidadPresupuesto] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento ContabilidadPresupuesto y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 7 - Se selecciona la opcion "Solicitar datos adicionales" [ContabilidadPresupuesto] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar que el tramite no exista [ContabilidadPresupuesto] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar que el tramite exista [ContabilidadPresupuesto] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar si los botones de acciones son correctos [ContabilidadPresupuesto] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento ContabilidadPresupuesto y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 8 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo aprueba el DEPARTAMENTO DE PATRIMONIO Y COMPRAS
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
#APRUEBO----------------------------------------
Test 8 - Se selecciona la opcion "Aprobar e informar al contribuyente" [OperadorPatrimonioCompras] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 9 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo rechaza el DEPARTAMENTO DE PATRIMONIO Y COMPRAS
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 9 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 9 - Verificar el estado del tramite (asignado) [OperadorPatrimonioCompras] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento OperadorPatrimonioCompras, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Verificar si los botones de acciones son correctos [OperadorPatrimonioCompras] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento OperadorPatrimonioCompras y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 9 - Se selecciona la opcion "Rechazar e informar al contribuyente" [OperadorPatrimonioCompras] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 9 - Verificar que el tramite no exista [OperadorPatrimonioCompras] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento OperadorPatrimonioCompras, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 9 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [OperadorPatrimonioCompras] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento OperadorPatrimonioCompras, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 9 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Administración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 10 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y el DEPARTAMENTO DE PATRIMONIO Y COMPRAS solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 10 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 10 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 10 - Verificar el estado del tramite (asignado) [OperadorPatrimonioCompras] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento OperadorPatrimonioCompras, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 10 - Verificar si los botones de acciones son correctos [OperadorPatrimonioCompras] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento OperadorPatrimonioCompras y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 10 - Se selecciona la opcion "Solicitar datos adicionales" [OperadorPatrimonioCompras] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar que el tramite no exista [OperadorPatrimonioCompras] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar que el tramite exista [OperadorPatrimonioCompras] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar si los botones de acciones son correctos [OperadorPatrimonioCompras] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento OperadorPatrimonioCompras y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 11 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo aprueba el DEPARTAMENTO DE RECURSOS HUMANOS
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
#APRUEBO----------------------------------------
Test 11 - Se selecciona la opcion "Aprobar e informar al contribuyente" [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 12 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo rechaza el DEPARTAMENTO DE RECURSOS HUMANOS
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 12 - Verificar si el boton cancelar tramite no existe - boton cancelar tramite [ciudadano] Paso 3 4
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Desde el usuario del ciudadano, se verifica que el boton cancelar tramite no exista dentro del tramite
    Asignar Tag Numerado
...
Test 12 - Verificar si el boton cancelar tramite no existe - boton cancelar tramite [ciudadano] Paso 5 6
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Desde el usuario del ciudadano, se verifica que el boton cancelar tramite no exista dentro del tramite
    Asignar Tag Numerado
...
#RECHAZO----------------------------------------
Test 12 - Se selecciona la opcion "Rechazar e informar al contribuyente" [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 12 - Verificar Estado Desde Usuario [ciudadano] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 12 - Verificar que el tramite no exista [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento RecursosHumanos, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 12 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento RecursosHumanos, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 12 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Administración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 13 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 13 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 13 - Verificar el estado del tramite (asignado) [RecursosHumanos] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento RecursosHumanos, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 13 - Verificar si los botones de acciones son correctos [RecursosHumanos] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento RecursosHumanos y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 13 - Se selecciona la opcion "Solicitar datos adicionales" [RecursosHumanos] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 13 - Verificar que el tramite no exista [RecursosHumanos] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 13 - Verificar que el tramite exista [RecursosHumanos] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 13 - Verificar si los botones de acciones son correctos [RecursosHumanos] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento RecursosHumanos y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#RECHAZO----------------------------------------
Test 13 - Se selecciona la opcion "Rechazar e informar al contribuyente" [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Departamento RecursosHumanos y utiliza la opcion "botonRechazarInformarAlContribuyente" para continuar con el proceso
    Asignar Tag Numerado
...
Test 13 - Verificar Estado Desde Usuario [ciudadano] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Entra desde el usuario para chequear que se actualiza el Estado del tramite segun en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 13 - Verificar que el tramite no exista [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento RecursosHumanos, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 13 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [RecursosHumanos] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento RecursosHumanos, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 14 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo aprueba el DEPARTAMENTO DE TESORERIA
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 14 - Verificar si el boton del tacho esta bloqueado - boton cancelar tramite [ciudadano] Paso 2 3
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    Abrir Navegador en modo incognito    ${pageCiudadano}
    [Documentation]    Desde el usuario del ciudadano, se verifica que el boton del tacho para cancelar el tramite se encuentre bloqueado
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 14 - Se selecciona la opcion "Aprobar e informar al contribuyente" [Tesoreria] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 15 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y lo rechaza el DEPARTAMENTO DE TESORERIA
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 15 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 15 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 15 - Verificar el estado del tramite (asignado) [Tesoreria] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Tesoreria, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 15 - Verificar si los botones de acciones son correctos [Tesoreria] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento Tesoreria y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 15 - Se selecciona la opcion "Rechazar e informar al contribuyente" [Tesoreria] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 15 - Verificar que el tramite no exista [Tesoreria] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Tesoreria, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 15 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Tesoreria] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Tesoreria, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 15 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Administración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 16 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE ADMINISTRACION y el DEPARTAMENTO DE TESORERIA solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 16 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 16 - Verificar si los botones de acciones son correctos [DireccionInformatica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Dirección de Administración y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 16 - Se selecciona la opcion "Derivar" [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Administración y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 16 - Verificar el estado del tramite (asignado) [Dirección de Administración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Administración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 16 - Verificar el estado del tramite (asignado) [Tesoreria] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Tesoreria, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 16 - Verificar si los botones de acciones son correctos [Tesoreria] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento Tesoreria y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 16 - Se selecciona la opcion "Solicitar datos adicionales" [Tesoreria] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 16 - Verificar que el tramite no exista [Tesoreria] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 16 - Verificar que el tramite exista [Tesoreria] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 16 - Verificar si los botones de acciones son correctos [Tesoreria] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento Tesoreria y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
