...
#cambiar lo que selecciono de la lista al crear los tramites!
...
Test 1 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
...
Test 1 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 13
...
Test 2 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 2 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 14
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 2 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 15
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 2 - Excencion Impuesto Provincial Automotor: se responde [ciudadano]
...
Test 3 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 3 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 14
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 4 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "enviar a Direccion" [operador mesa]
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (asignado) [responsable area] 12
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [Direccion] 2
...
Test 4 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "no corresponde" [Direccion]
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 21
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [Direccion] 4
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 4 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "para resolver" [Direccion]
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 36
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (resuelto) [ciudadano] 39
    [Documentation]    Desde el usuario del ciudadano, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - ciudadano    ${userCiudadano2}  ${passCiudadano}  ${circuloUsuario}
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 42
...
Test 4 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 49
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "enviar a Direccion" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (asignado) [responsable area] 12
    [Documentation]    Desde resp area, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [Direccion] 2
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "para resolver" [Direccion]
    [Documentation]    Entra como Direccion para continuar con el proceso, utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 22
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 28
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 5 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 35
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: Indicacion del proceso
...
Test 6 - Excencion Impuesto Provincial Automotor: Indicacion del numero de proceso creado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    [Documentation]    Numero del proceso creado: ${tramite}
    Asignar Tag Numerado
    Log To Console    Comentario del proceso

Test 6 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (pendiente) [ciudadano] 4
    [Documentation]    Desde el usuario del ciudadano, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - ciudadano    ${userCiudadano2}  ${passCiudadano}  ${circuloUsuario}
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [responsable area] 6
    [Documentation]    Desde resp area, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 8
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [operador mesa] 1
    [Documentation]    Se ingresa como operador mesa y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "enviar a Direccion" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (asignado) [responsable area] 12
    [Documentation]    Desde resp area, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [operador mesa] 13
    [Documentation]    Desde el operador mesa, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 15
    [Documentation]    Desde el gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [Direccion] 2
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "aprobar" [Direccion]
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [responsable area] 27
    [Documentation]    Desde resp area, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 28
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 29
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [operador mesa] 4
    [Documentation]    Se ingresa como operador mesa y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "informar contribuyente" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para informar al usuario de la decision final del proceso, en este caso "Rechazado"
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [responsable area] 34
    [Documentation]    Desde resp area, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 35
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 6 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 36
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: Indicacion del proceso
...
Test 7 - Excencion Impuesto Provincial Automotor: Indicacion del numero de proceso creado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    [Documentation]    Numero del proceso creado: ${tramite}
    Asignar Tag Numerado
    Log To Console    Comentario del proceso

Test 7 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (pendiente) [ciudadano] 4
    [Documentation]    Desde el usuario del ciudadano, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - ciudadano    ${userCiudadano2}  ${passCiudadano}  ${circuloUsuario}
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [responsable area] 6
    [Documentation]    Desde resp area, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 7
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 8
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [operador mesa] 1
    [Documentation]    Se ingresa como operador mesa y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "enviar a Direccion" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a Direccion
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar el estado del tramite (asignado) [responsable area] 12
    [Documentation]    Desde resp area, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [operador mesa] 13
    [Documentation]    Desde el operador mesa, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 15
    [Documentation]    Desde el gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [Direccion] 2
    [Documentation]    Se ingresa como Direccion y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "rechazar" [Direccion]
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [responsable area] 27
    [Documentation]    Desde resp area, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 28
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 29
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar si los botones de acciones son correctos [operador mesa] 4
    [Documentation]    Se ingresa como operador mesa y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: se selecciona la opcion "informar contribuyente" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para informar al usuario de la decision final del proceso, en este caso "Rechazado"
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userOperadorMesa}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [responsable area] 34
    [Documentation]    Desde resp area, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userRespArea}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [Direccion] 35
    [Documentation]    Desde Direccion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userSecretaria}  ${pass}  Reportes y Estadísticas
...
Test 7 - Excencion Impuesto Provincial Automotor: verificar que el tramite no exista [gestion] 36
    [Documentation]    Desde gestion, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    Inicio sesion y verificacion de texto inicial - operador    ${userGestion}  ${pass}  Reportes y Estadísticas
