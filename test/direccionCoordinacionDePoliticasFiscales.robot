...
...
...               -Test 1: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y lo aprueba la misma Direccion de coordinacion de politicas fiscales
...
...               -Test 2: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y lo rechaza la misma Direccion de coordinacion de politicas fiscales
...
...               -Test 3: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y desde la misma Direccion selecciona la opcion "No Corresponde"
...
...               -Test 4: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y desde la misma Direccion selecciona la opcion "Solicitar Datos Adicionales"
...
...               -Test 5: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y lo aprueba el Departamento de Control de Ejecución de Políticas Fiscales
...
...               -Test 6: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y lo rechaza el Departamento de Control de Ejecución de Políticas Fiscales
...
...               -Test 7: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y el Departamento de Control de Ejecución de Políticas Fiscales solicita datos adicionales
...
...               -Test 8: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y lo aprueba el Departamento de Control Fiscal en Ruta
...
...               -Test 9: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y lo rechaza el Departamento de Control Fiscal en Ruta
...
...               -Test 10: Se crea un tramite de la Direccion de coordinacion de politicas fiscales y el Departamento de Control Fiscal en Ruta solicita datos adicionales
