...
Test 1 /A - Excencion impuesto provincial automotor: Indicacion del proceso
...
Test 1 / A - Excencion impuesto provincial automotor: verificar que el tramite no exista - boton cancelar tramite [secretaria]
...
#////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Test 1 / B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... eliminar el tramite [ciudadano - operador mesa]
    Asignar Tag Numerado
...
Test 1 / B - Excencion impuesto provincial automotor: verificar que el tramite no exista - icono tacho de cancelar tramite [secretaria]
    [Documentation]    Desde secretaria, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 2 / A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
...
Test 2 / A - Excencion impuesto provincial automotor: verificar que el tramite no exista - boton cancelar tramite [secretaria]
    [Documentation]    Desde secretaria, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 2 / B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... solicitar datos adicionales [operador mesa]
    ...    ... eliminar tramite [ciudadano - secretaria]
...
Test 2 / B - Excencion impuesto provincial automotor: verificar que el tramite no exista - icono tacho de cancelar tramite [secretaria]
    [Documentation]    Desde secretaria, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 3 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
...
Test 3 / A - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria" [operador mesa]
...
#-------------------------------------------------- BOTON CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 3 / A - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 3 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... eliminar el tramite [ciudadano - gestion]
...
Test 3 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 3 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 3 / B - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
#-----------------------------------------------ICONO TACHO DE CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 3 / B - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 4 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
...
Test 4 /A - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 4 /A - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 4 / A - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 4 / A- Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
...
#-------------------------------------------------- BOTON CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 4 / A - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 4 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 4 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 4 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 4 / B - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 4 / B- Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 5 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
...
Test 5 /A - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 5 /A - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 5 / A - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 5 / A- Excencion impuesto provincial automotor: se selecciona la opcion "no corresponde" [secretaria]
...
Test 5 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... no corresponde [secretaria]
...
Test 5 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 5 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 5 / B - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 5 / B- Excencion impuesto provincial automotor: se selecciona la opcion "no corresponde" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso dandole a la opcion "No Corresponde" devolviendo el tramite hacia Mesa de Entrada.
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 6 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
...
Test 6 / A - Excencion impuesto provincial automotor: se selecciona la opcion "no corresponde" [operador mesa]
...
#-------------------------------------------------- BOTON CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 6 / A - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 6 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... no corresponde [operador mesa]
    ...    ... eliminar el tramite [ciudadano]
...
Test 6 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 6 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 6 / B - Excencion impuesto provincial automotor: se selecciona la opcion "no corresponde" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para indicar la opcion "No Corresponde"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 7 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 7 /A - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 7 /A - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 7 /A - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria". [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 7 /A - Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
#-------------------------------------------------- BOTON CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 7 / A - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 7 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 7 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 7 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 7 /B - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria". [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 7 /B - Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 7 /B- Excencion impuesto provincial automotor: se selecciona la opcion "aprobado" [gestion]
    [Documentation]    Entra como Gestion aprobando el tramite para continuar con el proceso
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 8 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 8 /A - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 8 /A - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 8 /A - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria". [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 8 /A - Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 8 / A - Excencion impuesto provincial automotor: se selecciona la opcion "rechazar" [gestion]
...
#-------------------------------------------------- BOTON CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 8 / A - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 8 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 8 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 8 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 8 /B - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria". [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 8 /B - Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 8 /B - Excencion impuesto provincial automotor: se selecciona la opcion "rechazar" [gestion]
    [Documentation]     Entra como Gestion Rechazando el tramite y continua con el proceso
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /A - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 9 /A - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria". [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /A - Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /A - Excencion impuesto provincial automotor: se selecciona la opcion "informar contribuyente" [operador mesa]
...
#-------------------------------------------------- BOTON CANCELAR TRAMITE ------------------------------------------
#///////Cancelar tramite
Test 9 / A - Excencion impuesto provincial automotor: cancelar tramite desde adentro del tramite [ciudadano]
    [Documentation]    Desde el ciudadano, se cancela el tramite presionando el boton "cancelar tramite"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /B - Excencion impuesto provincial automotor: Indicacion del proceso
    [Documentation]    El proceso que se realiza en el TEST 2 es el siguiente:
    ...    ... crear tramite [ciudadano] -
    ...    ... enviar a secretaria [operador mesa]
    ...    ... para resolver [secretaria]
...
Test 9 /B - Excencion impuesto provincial automotor: crear tramite [ciudadano]
    [Documentation]    El ciudadano crea una nueva Excencion impuesto provincial automotor
    Asignar Tag Numerado
    Crear tramite Excencion impuesto provincial automotor
    ${tramite}=    Obtener Numero De Tramite
...
Test 9 /B - Excencion impuesto provincial automotor: Indicacion del numero de proceso creado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
    #Sino corre
    [Documentation]    Numero del proceso creado: ${tramite}
...
Test 9 /B - Excencion impuesto provincial automotor: se selecciona la opcion "enviar a secretaria". [operador mesa]
    [Documentation]    Entra como operador mesa entrada para continuar con el proceso, enviando el tramite a secretaria
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /B - Excencion impuesto provincial automotor: se selecciona la opcion "para resolver" [secretaria]
    [Documentation]    Entra como Secretaria para continuar con el proceso,utilizando la opcion "Para Resolver" enviandolo hacia Gestion
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /B - Excencion impuesto provincial automotor: se selecciona la opcion "rechazar" [gestion]
    [Documentation]     Entra como Gestion Rechazando el tramite y continua con el proceso
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
...
Test 9 /B - Excencion impuesto provincial automotor: se selecciona la opcion "informar contribuyente" [operador mesa]
    [Documentation]    Entra como operador mesa entrada para informar al usuario de la decision final del proceso, en este caso "Rechazado"
    Asignar Tag Numerado
    #Si fallo lo anterior
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un test importante
