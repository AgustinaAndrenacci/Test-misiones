...
...
...               -Test 1: Se crea un tramite de la Direccion de fiscalizacion y lo aprueba la misma Direccion de fiscalizacion
...
...               -Test 2: Se crea un tramite de la Direccion de fiscalizacion y lo rechaza la misma Direccion de fiscalizacion
...
...               -Test 3: Se crea un tramite de la Direccion de fiscalizacion y desde la misma Direccion selecciona la opcion "No Corresponde"
...
...               -Test 4: Se crea un tramite de la Direccion de fiscalizacion y desde la misma Direccion selecciona la opcion "Solicitar Datos Adicionales"
...
...               -Test 5: Se crea un tramite de la Direccion de fiscalizacion y lo aprueba el Departamento de Fiscalización Externa
...
...               -Test 6: Se crea un tramite de la Direccion de fiscalizacion y lo rechaza el Departamento de Fiscalización Externa
...
...               -Test 7: Se crea un tramite de la Direccion de fiscalizacion y el Departamento de Fiscalización Externa solicita datos adicionales
...
...               -Test 8: Se crea un tramite de la Direccion de fiscalizacion y lo aprueba el Departamento de Fiscalización Interna
...
...               -Test 9: Se crea un tramite de la Direccion de fiscalizacion y lo rechaza el Departamento de Fiscalización Interna
...
...               -Test 10: Se crea un tramite de la Direccion de fiscalizacion y el Departamento de Fiscalización Interna solicita datos adicionales
...
...               -Test 11: Se crea un tramite de la Direccion de fiscalizacion y lo aprueba el Departamento de Liquidación y Administración
...
...               -Test 12: Se crea un tramite de la Direccion de fiscalizacion y lo rechaza el Departamento de Liquidación y Administración
...
...               -Test 13: Se crea un tramite de la Direccion de fiscalizacion y el Departamento de Liquidación y Administración solicita datos adicionales
...
...               -Test 14: Se crea un tramite de la Direccion de fiscalizacion y lo aprueba el Selección y Revisión
...
...               -Test 15: Se crea un tramite de la Direccion de fiscalizacion y lo rechaza el Selección y Revisión
...
...               -Test 16: Se crea un tramite de la Direccion de fiscalizacion y el Departamento de Selección y Revisión solicita datos adicionales
...
Test 5 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo aprueba el DEPARTAMENTO DE FISCALIZACION EXTERNA
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 5 - Se selecciona la opcion "Aprobar e informar al contribuyente" [FiscalizaciónExterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 6 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite}  - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo rechaza el DEPARTAMENTO DE FISCALIZACION EXTERNA
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 6 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 6 - Verificar el estado del tramite (asignado) [FiscalizaciónExterna] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónExterna, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Verificar si los botones de acciones son correctos [FiscalizaciónExterna] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento FiscalizaciónExterna y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 6 - Se selecciona la opcion "Rechazar e informar al contribuyente" [FiscalizaciónExterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 6 - Verificar que el tramite no exista [FiscalizaciónExterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónExterna, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 6 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [FiscalizaciónExterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónExterna, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 6 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Fiscalización] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 7 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y el DEPARTAMENTO DE FISCALIZACION EXTERNA solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 7 - Verificar si los botones de acciones son correctos [DireccionFiscalizacion] Paso 3
    ...
    Verificar Boton Sin Fallar  ${botonRechazarInformarAlContribuyente}  botonRechazarInformarAlContribuyente
    Verificar Boton Sin Fallar  ${botonAprobarInformarAlContribuyente}  botonAprobarInformarAlContribuyente
Test 7 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 7 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 7 - Verificar el estado del tramite (asignado) [FiscalizaciónExterna] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónExterna, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 7 - Verificar si los botones de acciones son correctos [FiscalizaciónExterna] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento FiscalizaciónExterna y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 7 - Se selecciona la opcion "Solicitar datos adicionales" [userFiscalizaciónExterna] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar que el tramite no exista [userFiscalizaciónExterna] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar que el tramite exista [userFiscalizaciónExterna] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar si los botones de acciones son correctos [FiscalizaciónExterna] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento FiscalizaciónExterna y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 8 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo aprueba el DEPARTAMENTO DE FISCALIZACION INTERNA
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
#APRUEBO----------------------------------------
Test 8 - Se selecciona la opcion "Aprobar e informar al contribuyente" [FiscalizaciónInterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 9 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo rechaza el DEPARTAMENTO DE FISCALIZACION INTERNA
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 9 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 9 - Verificar el estado del tramite (asignado) [FiscalizaciónInterna] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónInterna, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Verificar si los botones de acciones son correctos [FiscalizaciónInterna] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento FiscalizaciónInterna y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 9 - Se selecciona la opcion "Rechazar e informar al contribuyente" [FiscalizaciónInterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 9 - Verificar que el tramite no exista [FiscalizaciónInterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónInterna, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 9 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [FiscalizaciónInterna] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónInterna, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 9 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Fiscalización] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 10 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y el DEPARTAMENTO DE FISCALIZACION INTERNA solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 10 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 10 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 10 - Verificar el estado del tramite (asignado) [FiscalizaciónInterna] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento FiscalizaciónInterna, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 10 - Verificar si los botones de acciones son correctos [FiscalizaciónInterna] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento FiscalizaciónInterna y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 10 - Se selecciona la opcion "Solicitar datos adicionales" [userFiscalizaciónInterna] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar que el tramite no exista [userFiscalizaciónInterna] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar que el tramite exista [userFiscalizaciónInterna] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar si los botones de acciones son correctos [FiscalizaciónInterna] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento FiscalizaciónInterna y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 11 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo aprueba el DEPARTAMENTO DE LIQUIDACION Y ADMINISTRACION
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
#APRUEBO----------------------------------------
Test 11 - Se selecciona la opcion "Aprobar e informar al contribuyente" [LiquidaciónAdministración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 12 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo rechaza el DEPARTAMENTO DE LIQUIDACION Y ADMINISTRACION
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 12 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 12 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 12 - Verificar el estado del tramite (asignado) [LiquidaciónAdministración] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento LiquidaciónAdministración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 12 - Verificar si los botones de acciones son correctos [LiquidaciónAdministración] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento LiquidaciónAdministración y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 12 - Se selecciona la opcion "Rechazar e informar al contribuyente" [LiquidaciónAdministración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 12 - Verificar que el tramite no exista [LiquidaciónAdministración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento LiquidaciónAdministración, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 12 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [LiquidaciónAdministración] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento LiquidaciónAdministración, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 12 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Fiscalización] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 13 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y el DEPARTAMENTO DE LIQUIDACION Y ADMINISTRACION solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 13 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 13 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 13 - Verificar el estado del tramite (asignado) [LiquidaciónAdministración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento LiquidaciónAdministración, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 13 - Verificar si los botones de acciones son correctos [LiquidaciónAdministración] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento LiquidaciónAdministración y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 13 - Se selecciona la opcion "Solicitar datos adicionales" [userLiquidaciónAdministración] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 13 - Verificar que el tramite no exista [userLiquidaciónAdministración] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 13 - Verificar que el tramite exista [userLiquidaciónAdministración] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 13 - Verificar si los botones de acciones son correctos [LiquidaciónAdministración] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento LiquidaciónAdministración y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 14 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo aprueba el DEPARTAMENTO DE SELECCION Y REVISION
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
#APRUEBO----------------------------------------
Test 14 - Se selecciona la opcion "Aprobar e informar al contribuyente" [SelecciónRevisión] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 15 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y lo rechaza el DEPARTAMENTO DE SELECCION Y REVISION
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 15 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 15 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 15 - Verificar el estado del tramite (asignado) [SelecciónRevisión] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento SelecciónRevisión, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 15 - Verificar si los botones de acciones son correctos [SelecciónRevisión] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento SelecciónRevisión y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 15 - Se selecciona la opcion "Rechazar e informar al contribuyente" [SelecciónRevisión] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 15 - Verificar que el tramite no exista [SelecciónRevisión] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento SelecciónRevisión, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 15 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [SelecciónRevisión] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento SelecciónRevisión, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 15 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección de Fiscalización] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 16 - Indicacion del numero de proceso creado Paso 1
    Run Keyword If   '${TEST_OK}'!='PASS'    Skip   Se omite el test porque fallo un Test importante
    [Documentation]    Numero del proceso creado: ${tramite} - Se crea un tramite de la DIRECCION DE FISCALIZACION y el DEPARTAMENTO DE SELECCION Y REVISION solicita datos adicionales
    Asignar Tag Numerado
    Log To Console    Comentario del proceso
...
Test 16 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 16 - Verificar si los botones de acciones son correctos [DireccionFiscalizacion] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Dirección de Fiscalización y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
Test 16 - Se selecciona la opcion "Derivar" [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección de Fiscalización y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 16 - Verificar el estado del tramite (asignado) [Dirección de Fiscalización] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección de Fiscalización, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 16 - Verificar el estado del tramite (asignado) [SelecciónRevisión] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento SelecciónRevisión, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 16 - Verificar si los botones de acciones son correctos [SelecciónRevisión] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento SelecciónRevisión y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#Solicito datos **************************************************************************
Test 16 - Se selecciona la opcion "Solicitar datos adicionales" [userSelecciónRevisión] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 16 - Verificar que el tramite no exista [userSelecciónRevisión] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 16 - Verificar que el tramite exista [userSelecciónRevisión] Paso 6
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 16 - Verificar si los botones de acciones son correctos [SelecciónRevisión] Paso 55
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento SelecciónRevisión y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
