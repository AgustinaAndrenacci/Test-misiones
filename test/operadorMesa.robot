...
...
...               -Test 1: Se crea un tramite como borrador y se prueba que se pueda actualizar campos, que se vean las modificaciones y despues lo envia a empezar el flujo d eun tramite normal
...
...               -Test 2: Se crea un tramite y desde el operador mesa se utiliza la opcion "Solicitar Datos Adicionales" y continua con el flujo
...
...               -Test 3: Se crea un tramite y desde el operador mesa selecciona la opcion "No Corresponde" y continua con el flujo
...
