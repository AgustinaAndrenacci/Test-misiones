...
Test 4 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - Verificar si los botones de acciones son correctos [Dirección Jurídica y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Se selecciona la opcion "Derivar" [Dirección Jurídica y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 4 - Verificar el estado del tramite (asignado) [Asesoría Legal y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Verificar si los botones de acciones son correctos [Asesoría Legal y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#APRUEBO----------------------------------------
Test 4 - Se selecciona la opcion "Aprobar e informar al contribuyente" [Asesoría Legal y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Verificar que el tramite no exista [Asesoría Legal y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Asesoría Legal y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 4 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#APRUEBO----------------------------------------
Test 5 - Se selecciona la opcion "Rechazar e informar al contribuyente" [Asesoría Legal y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#Solicito datos **************************************************************************
Test 6 - Se selecciona la opcion "Solicitar datos adicionales" [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica para indicar la opcion "Solicitar Datos Adicionales"
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - operador  ${userDireccionJuridicaTecnica}  ${pass}  Reportes y Estadísticas
    Validar y hacer clic en el boton    ${botonBandejaEntrada}    botonBandejaEntrada
    Abrir Tramite Por Numero    ${tramite}
...
Test 6 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde Dirección Jurídica y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
    Inicio sesion y verificacion de texto inicial - operador  ${userDireccionJuridicaTecnica}  ${pass}  Reportes y Estadísticas
    Validar y hacer clic en el boton    ${botonBandejaEntrada}    botonBandejaEntrada
    Validar Tramite Inexistente    ${tablaOperador}    ${tramite}
...
Test 6 - Verificar que el tramite exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador mesa, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Se selecciona la opcion "Derivar" [Dirección Jurídica y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 6 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Verificar el estado del tramite (asignado) [Asesoría Legal y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Asesoría Legal y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 6 - Verificar si los botones de acciones son correctos [Asesoría Legal y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento Asesoría Legal y Técnica y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 6 - Se selecciona la opcion "Rechazar e informar al contribuyente" [Asesoría Legal y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Departamento Asesoría Legal y Técnica y utiliza la opcion "botonRechazarInformarAlContribuyente" para continuar con el proceso
    Asignar Tag Numerado
...
Test 6 - Verificar que el tramite no exista [Asesoría Legal y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Asesoría Legal y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 6 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 6 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Asesoría Legal y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento Asesoría Legal y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 6 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección Jurídica y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 7 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 7 - Se selecciona la opcion "Derivar" [Dirección Jurídica y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 7 - Verificar el estado del tramite (asignado) [CobroJudicial] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar si los botones de acciones son correctos [CobroJudicial] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#APRUEBO----------------------------------------
Test 7 - Se selecciona la opcion "Aprobar e informar al contribuyente" [CobroJudicial] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar que el tramite no exista [CobroJudicial] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 7 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [CobroJudicial] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 7 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 8 - Se selecciona la opcion "Rechazar e informar al contribuyente" [CobroJudicial] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#Solicito datos **************************************************************************
Test 9 - Se selecciona la opcion "Solicitar datos adicionales" [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica para indicar la opcion "Solicitar Datos Adicionales"
    Asignar Tag Numerado
...
Test 9 - Verificar que el tramite exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador mesa, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Se selecciona la opcion "Derivar" [Dirección Jurídica y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 9 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Verificar el estado del tramite (asignado) [CobroJudicial] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento CobroJudicial, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 9 - Verificar si los botones de acciones son correctos [CobroJudicial] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento CobroJudicial y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 9 - Se selecciona la opcion "Rechazar e informar al contribuyente" [CobroJudicial] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Departamento CobroJudicial y utiliza la opcion "botonRechazarInformarAlContribuyente" para continuar con el proceso
    Asignar Tag Numerado
...
Test 9 - Verificar que el tramite no exista [CobroJudicial] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento CobroJudicial, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 9 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 9 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [CobroJudicial] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento CobroJudicial, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 9 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección Jurídica y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 10 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 2
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 10 - Se selecciona la opcion "Derivar" [Dirección Jurídica y Técnica] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 10 - Verificar el estado del tramite (asignado) [PenalTributariaJuiciosUniversales] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar si los botones de acciones son correctos [PenalTributariaJuiciosUniversales] Paso 3
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#APRUEBO----------------------------------------
Test 10 - Se selecciona la opcion "Aprobar e informar al contribuyente" [PenalTributariaJuiciosUniversales] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar que el tramite no exista [PenalTributariaJuiciosUniversales] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 10 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [PenalTributariaJuiciosUniversales] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
...
Test 10 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 11 - Se selecciona la opcion "Rechazar e informar al contribuyente" [PenalTributariaJuiciosUniversales] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
...
#Solicito datos **************************************************************************
Test 12 - Se selecciona la opcion "Solicitar datos adicionales" [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica para indicar la opcion "Solicitar Datos Adicionales"
    Asignar Tag Numerado
...
Test 12 - Verificar que el tramite exista [Dirección Jurídica y Técnica] Paso 4
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el operador mesa, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 12 - Se selecciona la opcion "Derivar" [Dirección Jurídica y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Dirección Jurídica y Técnica y utiliza la opcion "Derivar" para continuar con el proceso
    Asignar Tag Numerado
...
Test 12 - Verificar el estado del tramite (asignado) [Dirección Jurídica y Técnica] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 12 - Verificar el estado del tramite (asignado) [PenalTributariaJuiciosUniversales] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento PenalTributariaJuiciosUniversales, se verifica el estado del tramite para saber en que parte del ciclo esta
    Asignar Tag Numerado
...
Test 12 - Verificar si los botones de acciones son correctos [PenalTributariaJuiciosUniversales] Paso 5
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Se ingresa como Departamento PenalTributariaJuiciosUniversales y se verifica que aparezcan los botones de acciones correctos
    Asignar Tag Numerado
...
#APRUEBO----------------------------------------
Test 12 - Se selecciona la opcion "Rechazar e informar al contribuyente" [PenalTributariaJuiciosUniversales] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque hubo un fallo en el flujo del tramite anteriormente
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Entra como Departamento PenalTributariaJuiciosUniversales y utiliza la opcion "botonRechazarInformarAlContribuyente" para continuar con el proceso
    Asignar Tag Numerado
...
Test 12 - Verificar que el tramite no exista [PenalTributariaJuiciosUniversales] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento PenalTributariaJuiciosUniversales, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 12 - Verificar que el tramite no exista [Dirección Jurídica y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica que no se pueda visualizar el tramite
    Asignar Tag Numerado
...
Test 12 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [PenalTributariaJuiciosUniversales] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde el departamento PenalTributariaJuiciosUniversales, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
...
Test 12 - Verificar el estado y la existencia del tramite en "Tramites Finalizados" [Dirección Jurídica y Técnica] Paso 7
    Run Keyword If    '${TEST_OK}' != 'PASS'    Skip    Se omite el Test porque falló la creacion del tramite
    Abrir Navegador en modo incognito    ${pagePersonal}
    [Documentation]    Desde la Dirección Jurídica y Técnica, se verifica el estado del tramite para saber en que parte del ciclo esta , ademas, se verifica que el tramite se encuentre en la seccion Tramites Finalizados
    Asignar Tag Numerado
